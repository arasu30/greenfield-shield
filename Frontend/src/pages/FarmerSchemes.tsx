        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-fade-up">
            ...
            {isLoading ? (
                <div className="flex flex-col items-center justify-center py-20 text-slate-500">
                    ...
                    <p className="text-sm">{t("schemes.loading")}</p>
                </div>
            ) : schemes.length > 0 ? (
                        ...
                        <Card key={scheme.id} className="glass-card-hover rounded-xl group flex flex-col">
                            <CardHeader className="pb-4 border-b border-white/[0.06]">
                                <div className="flex items-start justify-between">
                                    ...
                                    <Badge variant="outline" className="text-xs bg-emerald-500/15 text-emerald-400 border-emerald-500/20">{t("schemes.open")}</Badge>
                                </div>
                            </CardHeader>
                                ...
                                <div className="space-y-3 mb-6 flex-1">
                                    {scheme.benefits && (
                                        <div className="flex items-start gap-2.5">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-medium text-blue-400 uppercase tracking-wider mb-0.5">{t("schemes.benefits")}</p>
                                    ...
                                    {scheme.eligibility_criteria && (
                                        <div className="flex items-start gap-2.5">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-medium text-emerald-400 uppercase tracking-wider mb-0.5">{t("schemes.eligibility")}</p>
                                    ...
                                    {scheme.required_documents && (
                                        <div className="flex items-start gap-2.5">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-medium text-amber-400 uppercase tracking-wider mb-0.5">{t("schemes.documents")}</p>
                ...
                <div className="glass-card rounded-2xl flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <h3 className="text-lg font-medium text-slate-300 mb-1">{t("schemes.noSchemes")}</h3>
                    <p className="text-sm text-slate-600">{t("schemes.checkBack")}</p>
                </div>
            )}
        </div>
    );
