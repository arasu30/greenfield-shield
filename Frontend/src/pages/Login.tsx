...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex bg-[#0a0f1e] font-sans relative overflow-hidden">
            <AnimatedParticles />
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-lg glass-card rounded-2xl p-8 space-y-6 animate-scale-in border border-white/[0.08]">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            {/* <h2 className="text-xl font-semibold text-white">{t(lang, "about.heading")}</h2> */}
                            {/* <p className="text-sm text-slate-400 leading-relaxed max-w-sm mx-auto">{t(lang, "about.desc")}</p> */}
                        </div>
                        {/* <div className="grid grid-cols-3 gap-3">
                            {[
                                { value: "10K+", label: t(lang, "about.farmersProtected") },
                                { value: "₹2Cr+", label: t(lang, "about.claimsSettled") },
                                { value: "98%", label: t(lang, "about.satisfaction") },
                            ].map((stat, i) => (
                                <div key={i} className="text-center p-3 bg-white/[0.03] rounded-lg border border-white/[0.04]">
