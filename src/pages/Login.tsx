            ...
            <Tabs defaultValue="farmer" className="w-full">
              ...
              <TabsContent value="farmer" className="space-y-5 mt-6">
                <div className="flex justify-center mb-6">
                  <div className="bg-slate-800/50 p-1 rounded-lg border border-slate-700/50 flex text-sm">
                    <button
                      onClick={() => setIsFarmerRegistering(false)}
                      className={`px-4 py-2 rounded-md transition-all ${!isFarmerRegistering ? 'bg-green-600 text-white shadow-lg shadow-green-900/20' : 'text-slate-400 hover:text-slate-200'
                        }`}
                    >
                      Login
                    </button>
